export const navigationWaiter = {
  mainNav: [
    ...
    [
      { name: 'My Info', to: '/waiter/myInfo', current: false },
      { name: 'Settings', to: '/waiter/settings', current: false },
      { name: 'Log out', to: '/Logout', current: false },
    ]
}
export const navigationChef = {
  mainNav: [
    { name: 'Tables', to: '/chef/tables', current: false },
    { name: 'Chef work zone', to: '/chef/workLane', current: false },
    { name: 'Menu', to: '/chef/menu', current: false },
    { name: 'Shift  Page', to: '/chef/shiftPage', current: false },

  ], secenderyNav:
    [
      { name: 'My Info', to: '/chef/myInfo', current: false },
      { name: 'Settings', to: '/chef/settings', current: false },
      { name: 'Log out', to: '/Logout', current: false },
    ]
}
...
export const navigationBartender = {
  mainNav: [
    { name: 'Tables', to: '/tables', current: false },
    { name: 'Bar`s work zone', to: '/worker/workLane', current: false },
    { name: 'Menu', to: '/worker/menu', current: false },
    { name: 'Shift  Page', to: '/worker/shiftPage', current: false },
...
export const navigationShiftManager = {
  ...
  secenderyNav:
    [
      { name: 'My Info', to: '/worker/myInfo', current: false },
      { name: 'Settings', to: '/worker/settings', current: false },
      { name: 'Log out', to: '/Logout', current: false },
    ]
}
